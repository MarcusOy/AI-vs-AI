...
const ReplayPage = () => {
    ...
    const goBackwardAGame = () => navigate(`/Battle/${bid}/${Number.parseInt(gnum!) - 1}`)
    const goForwardAGame = () => navigate(`/Battle/${bid}/${Number.parseInt(gnum!) + 1}`)
    ...
    const isAttackerTurn = currentTurn > 0 && turns[currentTurn - 1].isAttackTurn
